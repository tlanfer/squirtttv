<script>
    ...
    function save() {
        $config.events.resubt2[selectedIndex] = selectedEvent
        showModal = false;
        selectedIndex = -1;
        selectedEvent = {};
    }
    ...
    function del() {
        ...
        $config.events.resubt2 = events.filter((e, i) => i !== selectedIndex);
        showModal = false;
        selectedIndex = -1;
        selectedEvent = {};
    }
