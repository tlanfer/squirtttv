<script>
    ...
    function save() {
        $config.events.resubt3[selectedIndex] = selectedEvent
        showModal = false;
        selectedIndex = -1;
        selectedEvent = {};
    }
    ...
    function del() {
        ...
        $config.events.resubt3 = events.filter((e, i) => i !== selectedIndex);
        showModal = false;
        selectedIndex = -1;
        selectedEvent = {};
    }
