<script>
    ...
    function save() {
        $config.events.gifts[selectedIndex] = selectedEvent
        showModal = false;
        selectedIndex = -1;
        selectedEvent = {};
    }
    ...
    function del() {
        ...
        $config.events.gifts = events.filter((e, i) => i !== selectedIndex);
        showModal = false;
        selectedIndex = -1;
        selectedEvent = {};
    }
